package  
{
	...
	{
		[Embed(source = '../assets/MAGI.png')] private var playerPNG:Class;
		...
		public var phased:Boolean = false;
		
		public var goldModifier:int = 1;
		
		public var mana:int = 1000;
		public var maxMana:int = 1000;
		//public var currentExp:int = 0;
		//public var levelExp:int = 100;
		/*	currentPrimary.wId
			currentPrimary.wName
			currentPrimary.wType
			currentPrimary.wDamage
			currentPrimary.wFireRate
			currentPrimary.wVelocity
			currentPrimary.wMaxSpeed
			currentPrimary.wLife
			currentPrimary.wLifeSpan
			currentPrimary.wCurrentLevel
			currentPrimary.wMaxLevel
			currentPrimary.wExpArray
			currentPrimary.wCurrentExp
			currentPrimary.wMaxExp
			currentPrimary.wGoldCost*/
		...
		override public function update():void
		{
			...
			/*if (FlxG.keys.SPACE() && currentBombs > 0 && exists)
			{
				currentBombs -= 1;
			}*/
