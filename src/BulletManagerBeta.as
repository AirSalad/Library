package  
{
	...
	{	
		...
		public function loadWeapons():void
		{
			...
			//GOLD
			goldSmall = new FlxMovieWeapon("Gold small", Registry.goldCenter);
			...
			goldSmall.setParent(Registry.goldCenter, "x", "y", -10, -10);
			goldSmall.setBulletMagazine(goldSmallObject.wMagSize, goldSmallObject.wMagSpeed);
			add(goldSmall.group);
			
			goldMedium = new FlxMovieWeapon("Gold medium", Registry.goldCenter);
			//primaryWeapon.makeImageBullet(basicObject.wBulletPool, bulletPNG);
			...
			goldMedium.setParent(Registry.goldCenter, "x", "y", -15, -15);
			goldMedium.setBulletMagazine(goldMediumObject.wMagSize, goldMediumObject.wMagSpeed);
			add(goldMedium.group);
			
			goldLarge = new FlxMovieWeapon("Gold large", Registry.goldCenter);
			//primaryWeapon.makeImageBullet(basicObject.wBulletPool, bulletPNG);
			...
			goldLarge.setParent(Registry.goldCenter, "x", "y", -20, -20);
			...
			{
				case 0://Basic
				/*primaryMovieWeapon = new FlxMovieWeapon("Basic", Registry.playerCenter);
				...
				primaryMovieWeapon.setParent(Registry.playerCenter, "x", "y", -10, -10);
				primaryMovieWeapon.setBulletMagazine(basicObject.wMagSize, basicObject.wMagSpeed);
				add(primaryMovieWeapon.group);*/
					
				primaryWeapon = new FlxMovieWeapon("Basic", Registry.playerCenter);
				//primaryWeapon.makeImageBullet(basicObject.wBulletPool, bulletPNG);
				...
				primaryWeapon.setParent(Registry.playerCenter, "x", "y", -10, -10);
				primaryWeapon.setBulletMagazine(basicObject.wMagSize, basicObject.wMagSpeed);
				add(primaryWeapon.group);
				
				//bombWeapon = new FlxMovieWeapon("Basic Bomb", Registry.playerCenter);
				bombWeapon = new FlxWeapon("Basic Bomb", Registry.playerCenter);
				...
				bombWeapon.setParent(Registry.playerCenter, "x", "y", -10, -10);
				bombWeapon.setBulletMagazine(basicBombObject.wMagSize, basicBombObject.wMagSpeed);
				add(bombWeapon.group);
				break;
				
				case 1://Flame
				primaryWeapon = new FlxMovieWeapon("Flame", Registry.playerCenter);
				...
				bombWeapon = new FlxWeapon("Flame Bomb", Registry.playerCenter);
				...
				case 2://Gravity
				primaryWeapon = new FlxMovieWeapon("Gravity", Registry.playerCenter);
				...
				bombMovieWeapon = new FlxMovieWeapon("Gravity Bomb", Registry.playerCenter);
				...
				bombMovieWeapon.setParent(Registry.playerCenter, "x", "y", -10, -10);
				...
				case 3://Knockback
				primaryWeapon = new FlxMovieWeapon("Knockback", Registry.playerCenter);
				...
				bombWeapon = new FlxWeapon("Knockback Bomb", Registry.playerCenter);
				...
				bombWeapon.setParent(Registry.playerCenter, "x", "y", -22.5, -22.5);
				...
				bombWeapon = new FlxWeapon("Laser Bomb", Registry.playerCenter);
				...
				case 5://Melee
				primaryWeapon = new FlxMovieWeapon("Melee", Registry.playerCenter);
				...
				primaryWeapon.setParent(Registry.playerCenter, "x", "y", -125, -125);
			//	primaryWeapon.
				primaryWeapon.setBulletMagazine(meleeObject.wMagSize, meleeObject.wMagSpeed);
				add(primaryWeapon.group);
				
				bombMovieWeapon = new FlxMovieWeapon("Melee Bomb", Registry.playerCenter);
				...
				bombMovieWeapon.setParent(Registry.playerCenter, "x", "y", -200, -200);
				bombMovieWeapon.setBulletMagazine(meleeBombObject.wMagSize, meleeBombObject.wMagSpeed);
				add(bombMovieWeapon.group);
				break;
				
				case 6://Mine
				primaryWeapon = new FlxMovieWeapon("Mine", Registry.playerCenter);
				...
				explosionWeapon = new FlxMovieWeapon("Explosion", Registry.bulletCenter);//primaryWeapon);
				...
				explosionWeapon.setParent(Registry.bulletCenter, "x", "y", -75, -75);
				explosionWeapon.setBulletMagazine(explosiveObject.wMagSize, explosiveObject.wMagSpeed);
				add(explosionWeapon.group);
				
				bombMovieWeapon = new FlxMovieWeapon("Mine Bomb", Registry.playerCenter);
				...
				bombMovieWeapon.setParent(Registry.playerCenter, "x", "y", -20, -20);
				bombMovieWeapon.setBulletMagazine(mineBombObject.wMagSize, mineBombObject.wMagSpeed);
				add(bombMovieWeapon.group);
				
				bombExplosionWeapon = new FlxMovieWeapon("Mine Bomb", Registry.bulletCenter);
				...
				bombExplosionWeapon.setParent(Registry.bulletCenter, "x", "y", -125, -125);
				...
				case 7://Pierce
				primaryWeapon = new FlxMovieWeapon("Pierce", Registry.playerCenter);
				...
				primaryWeapon.setParent(Registry.playerCenter, "x", "y", -15, -15);
				primaryWeapon.setBulletElasticity(1);
				primaryWeapon.setBulletMagazine(pierceObject.wMagSize, pierceObject.wMagSpeed);
				add(primaryWeapon.group);
				
				bombMovieWeapon = new FlxMovieWeapon("Pierce Bomb", Registry.playerCenter);
				...
				bombMovieWeapon.setParent(Registry.playerCenter, "x", "y", -50, -50);
				bombMovieWeapon.setBulletMagazine(pierceBombObject.wMagSize, pierceBombObject.wMagSpeed);
				add(bombMovieWeapon.group);
				break;
				
				case 8://Rapid
				primaryWeapon = new FlxMovieWeapon("Rapid", Registry.playerCenter);
				...
				bombMovieWeapon = new FlxMovieWeapon("Rapid Bomb", Registry.playerCenter);
				...
				case 9://Rocket
				primaryWeapon = new FlxMovieWeapon("Rocket", Registry.playerCenter);
				...
				bombMovieWeapon = new FlxMovieWeapon("Rocket Bomb", Registry.playerCenter);
				...
				case 10://Shotgun
				primaryWeapon = new FlxMovieWeapon("Shotgun", Registry.playerCenter);
				...
				bombMovieWeapon = new FlxMovieWeapon("Shotgun Bomb", Registry.playerCenter);
				...
				case 11://Spread
				primaryWeapon = new FlxMovieWeapon("Spread", Registry.playerCenter);
				...
				bombWeapon = new FlxWeapon("Spread Bomb", Registry.playerCenter);
			...
			{
				case 0:
				secondaryWeapon = new FlxMovieWeapon("Basic", Registry.orb);
				...
				secondaryWeapon.setParent(Registry.orb, "x", "y", -10, -10);
				secondaryWeapon.setBulletMagazine(basicObject.wMagSize, basicObject.wMagSpeed);
				add(secondaryWeapon.group);
				break;
				
				case 1://Flame
				secondaryWeapon = new FlxMovieWeapon("Flame", Registry.orb);
				...
				case 2://Gravity
				secondaryWeapon = new FlxMovieWeapon("Gravity", Registry.orb);
				...
				case 3://Knockback
				secondaryWeapon = new FlxMovieWeapon("Knockback", Registry.orb);
				...
				case 5://Melee
				secondaryWeapon = new FlxMovieWeapon("Melee", Registry.orb);
				...
				secondaryWeapon.setParent(Registry.orb, "x", "y", -125, -125);
				secondaryWeapon.setBulletMagazine(meleeObject.wMagSize, meleeObject.wMagSpeed);
				add(secondaryWeapon.group);
				break;
				
				case 6://Mine
				secondaryWeapon = new FlxMovieWeapon("Mine", Registry.orb);
				...
				explosionWeapon = new FlxMovieWeapon("Explosion", Registry.bulletCenter);//secondaryWeapon);
				//explosionWeapon.makeImageBullet(mineObject.wBulletPool, explosionPNG);
				explosionWeapon.makeMovieBullet(explosiveObject.wBulletPool, explosionMC, 0, 0, 150, 150);
				explosionWeapon.setBulletDamage(explosiveObject.wDamage);
				explosionWeapon.setFireRate(explosiveObject.wFireRate);
				...
				case 7://Pierce
				secondaryWeapon = new FlxMovieWeapon("Pierce", Registry.orb);
				...
				secondaryWeapon.setParent(Registry.orb, "x", "y", -15, -15);
				secondaryWeapon.setBulletElasticity(1);
				...
				case 8://Rapid
				secondaryWeapon = new FlxMovieWeapon("Rapid", Registry.orb);
				...
				case 9://Rocket
				secondaryWeapon = new FlxMovieWeapon("Rocket", Registry.orb);
				...
				case 10://Shotgun
				secondaryWeapon = new FlxMovieWeapon("Shotgun", Registry.orb);
				...
				case 11://Spread
				secondaryWeapon = new FlxMovieWeapon("Spread", Registry.orb);
		...
		/*public function createWeapon(wId:int,wName:String,wImage:Class,wType:String,wMag:int,wDamage:int,wBulletsShot:int,wFireRate:int,wVelocity:int,wMaxSpeed:int,wLife:int,wCurrentExp:int,wMaxExp:int,wCurrentLevel:int,wMaxLevel:int,wGoldCost:int):void
		{
			if (wId == 1)
			{
					...
					primaryWeapon.setParent(Registry.orb, "x", "y", -10, -10);
